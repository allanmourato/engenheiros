...
@Entity
public class DesligamentoUsuario implements Serializable {
	...
	public Date getDataDoDesligamento() {
		return dataDoDesligamento;
	}
	public void setDataDoDesligamento(Date dataDoDesligamento) {
		this.dataDoDesligamento = dataDoDesligamento;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DesligamentoUsuario other = (DesligamentoUsuario) obj;
		if (id != other.id)
			return false;
		return true;
	}
